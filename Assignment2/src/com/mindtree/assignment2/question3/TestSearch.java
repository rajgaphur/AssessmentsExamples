...
public class TestSearch {
	...
	public void UTC03_01() {
		...
		boolean result = SearchElements.searchGivenElements('L', 15);
	...
	public void UTC03_02() {
		...
		Search search = new LinearSearch();
		search.addElements(arrayElements);
		boolean result = SearchElements.searchGivenElements('B', 1300);
	...
	public void UTC03_03() {
		...
		Search search = new LinearSearch();
		search.addElements(arrayElements);
		boolean result = SearchElements.searchGivenElements('B', 456);
